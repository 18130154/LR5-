...
class Table{
    ...
    private function generateRow($queryTab, $result, $switch){
        ...
        while ($row=mysqli_fetch_array($result)){
            ...
            if($switch){
                echo "<td><a href='/phpbatalova/www/lab5/edit.php?id=". $row['id']. "& query=".$queryTab. "'>Изменить</a></td>";
				echo "<td><a href='/phpbatalova/www/lab5/delete.php?id=". $row['id']. "& query=". $queryTab. "'>Удалить</a></td>";
            }
			echo "</tr>";
        }
    }
